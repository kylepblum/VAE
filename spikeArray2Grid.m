function gridElec = spikeArray2Grid(params)

%Get Mapfile from server
if strcmpi(params.monkey,'Han')
    filepath = ['/Volumes/L_MillerLab/limblab/'...
        'lab_folder/Animal-Miscellany/Han_13B1/map files/Left S1'];
    data = readtable([filepath filesep 'SN 6251-001459.txt'],'HeaderLines',14);
    
elseif strcmpi(params.monkey,'Duncan')
    filepath = ['/Volumes/L_MillerLab/limblab/'...
        'lab_folder/Animal-Miscellany/Duncan_17L1/mapfiles/left S1 20190205'];
...
elseif strcmpi(params.monkey,'Chips')
    filepath = ['/Volumes/L_MillerLab/limblab-archive/'...
        'Retired Animal Logs/Monkeys/Chips_12H1/map_files/left S1'];
